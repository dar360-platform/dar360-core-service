...
public interface UserService {
    ...
    void verifyRera(ReraVerificationRequest verificationRequest);

    UserResponse inviteOwner(OwnerInviteRequest inviteRequest);

    List<UserResponse> getInvitedOwners();
